...
class Vaihingen2D(VisionDataset):
    ...
    * https://doi.org/10.5194/isprsannals-I-3-293-2012
    ...
    def __getitem__(self, index: int) -> Dict[str, Tensor]:
        ...
        mask = to_pil_image(mask.float()/255.0)
...
class Vaihingen2DDataModule(pl.LightningDataModule):
    ...
    def setup(self, stage: Optional[str] = None):
        self.val = Vaihingen2D(self.root, self.val_transforms, split='val')
        self.train = Vaihingen2D(self.root, self.train_transforms, split='train')
    ...
    def get_num_classes(self):
        return 6 # with background/clutter